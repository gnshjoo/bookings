...
// SearchAvailabilityByDatesByRoomID returns true if availability exists for room_id, and false if no availability exists
...
// GetRoomByID get id from room info
